...
import (
	...
	"github.com/Bossnicks/read_adviser_bot/events"
	"github.com/Bossnicks/read_adviser_bot/lib/e"
	"github.com/Bossnicks/read_adviser_bot/storage"
)
...
func (p *Processor) Fetch(limit int) ([]events.Event, error) {
	...
	if err != nil {
		return nil, e.WrapIfErr("can't ger events", err)
	}
